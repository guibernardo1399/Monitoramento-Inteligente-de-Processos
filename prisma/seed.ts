...
async function main() {
  ...
  await prisma.processPublication.createMany({
    data: [
      {
        processId: processA.id,
        externalReference: "DJEN-processo-a-intimacao-manifestacao",
        fingerprintHash: "seed-processo-a-intimacao-manifestacao",
        cnjNumber: processA.cnjNumber,
        publicationDate: subHours(new Date(), 6),
        availabilityDate: subHours(new Date(), 10),
        actType: "Intimacao",
        source: "DJEN",
        court: processA.court,
        judgingBody: processA.judgingBody,
      ...
      {
        processId: processB.id,
        externalReference: "DJEN-processo-b-publicacao-certidao",
        fingerprintHash: "seed-processo-b-publicacao-certidao",
        cnjNumber: processB.cnjNumber,
        publicationDate: subDays(new Date(), 1),
        availabilityDate: subDays(new Date(), 1),
        actType: "Certidao",
        source: "DJEN",
        court: processB.court,
        judgingBody: processB.judgingBody,
        title: "Publicacao de certidao",
        excerpt: "Disponibilizada certidao referente ao cumprimento de diligencia pelo oficial de justica.",
